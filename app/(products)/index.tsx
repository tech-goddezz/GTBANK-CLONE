...
// "Financial Products" list — GT banking products (Loans, Pensions, Dollar
// Fund, Money Mkt) the user can apply for. Each card opens its own
// requirements/form flow at app/(products)/[id].tsx.
//
// Moved here from app/(tabs)/transactions.tsx — that route now shows the
// actual "Transactions" tab from the design (promo banners over the
// transaction history). This screen is reached from those promo banners,
// e.g. tapping "Apply for loans" pushes here filtered/scrolled to loans,
// or via router.push('/(products)') directly.
