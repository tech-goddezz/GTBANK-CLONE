...
export default function ChangeMPINScreen() {
  ...
  const handleProceed = () => {
    if (oldPin.length < 4) { setError('Enter your old PIN'); return; }
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.successContent}>
          ...
          <Text style={styles.successSub}>
            Your mPIN has been successfully updated. Use your new mPIN to securely access the app.
          </Text>
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.scroll}>
        ...
        <Text style={styles.title}>Change mPin</Text>
        <Text style={styles.subtitle}>Secure and enhance your transaction preferences.</Text>
        <InputField placeholder="Enter your old PIN" value={oldPin} onChangeText={setOldPin} secureTextEntry keyboardType="number-pad" maxLength={6} />
        <InputField placeholder="Enter new PIN" value={newPin} onChangeText={setNewPin} secureTextEntry keyboardType="number-pad" maxLength={6} />
        <InputField placeholder="Re-enter your new PIN" value={confirmPin} onChangeText={setConfirmPin} secureTextEntry keyboardType="number-pad" maxLength={6} error={error} />
